...
/**
 * Web service response class for ListMessagesServiceResponse
 *
 * @author Richa Pandey
 *
 */
public class ListMessagesServiceResponse {
	...
	public ListMessagesServiceResponse() {
		super();
	}

	public ListMessagesServiceResponse(String status, String error, int totalmessages,
			List<QlikMessageDto> qlikmessages) {
		super();
		this.status = status;
		this.error = error;
